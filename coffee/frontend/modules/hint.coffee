class Hint
  ...
  hintable = "a,area[href],input:not([type=hidden]),textarea,select,button,*[onclick],[role=link],[role=checkbox],[role=button],[role=tab],[role=menubar],[contenteditable],.js-new-tweets-bar"
